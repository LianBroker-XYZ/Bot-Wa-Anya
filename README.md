...
Edit bagian `config.js`, lalu sesuaikan owner dan pengaturan bot.

```js
global.owner = [['628xxxx', 'KaaOffc', true]]
global.mods = []
global.prems = []
...
<p align="center">
  <i>Recode by Kurumi • Theme by Anya MD • Created by KaaOffc</i>
</p>
