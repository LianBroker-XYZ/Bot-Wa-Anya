...
let handler = async (m, { conn, usedPrefix, command, text, isOwner }) => {
  ...
  let typeMenu = setting.setmenu || 1
  ...
  let menuType = (text || '').toString().trim()
...
`.trim()
  ...
  try {
    ...
    thumb = await (
      await fetch('https://raw.githubusercontent.com/hamm-r/uploader/main/1781961877534-928.jpg')
    ).buffer()
  }
...
`.trim(),
      ...
      offerCode: 'ANYA-MD',
      offerUrl: 'https://chat.whatsapp.com/I1gDskEAdxBLqOWHJs1RjN',
      ...
      nativeFlow: [
...

        {
          ...
          url: 'https://chat.whatsapp.com/I1gDskEAdxBLqOWHJs1RjN',
