...
import { useMultiFileAuthState, Browsers, fetchLatestBaileysVersion, makeCacheableSignalKeyStore } from '@itsliaaa/baileys';
...
// AUTO RESET LIMIT
// ==================
console.log('⏱️ Auto reset system aktif')
...
setInterval(async () => {
  ...
  let jam = now.toLocaleString('id-ID', {
  ...
  for (let jid in users) {
    ...
    // owner / premium bisa diskip kalau mau
